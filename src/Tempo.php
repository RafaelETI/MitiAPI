...
class Tempo
{
    ...
    public static function somar()
    {
        ...
        foreach (func_get_args() as $Intervalo) {
            $DateTime->add($Intervalo);
        }
    ...
    public static function subtrair()
    {
        ...
        foreach ($parametros as $Intervalo) {
            $DateTime->sub($Intervalo);
        }
