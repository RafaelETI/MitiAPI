...
class MitiBD{
	...
	public function __construct($servidor=BD_SERVIDOR,$usuario=BD_USUARIO,$senha=BD_SENHA,$banco=BD_BANCO,$charset=BD_CHARSET){
		...
		if($this->conexao->connect_error){throw new Exception('Nгo foi possнvel conectar ao banco de dados');}
	...
	public function requisitar($sql){
		...
		if($this->conexao->error){throw new Exception('Houve um erro ao realizar a requisiзгo');}
